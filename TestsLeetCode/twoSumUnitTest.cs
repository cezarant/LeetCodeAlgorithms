...
namespace TestsLeetCode
{
    ...
    public class twoSumUnitTest
    {
        ...
        public void testTwoSum()
        {
            ...
            expected = new int[] { 0, 21 };
            output.Should().BeEquivalentTo(expected);

            output = vo_leetCodeAlg.twoSum(new int[] { 2, 5, -70, 0, 35, 41, 4, 4, 26, 29, 56, 21, -19, 38, 31, 33, 37, 39, -46, 65, 71, 68 }, 8);
            expected = new int[] { 6, 7 };
            output.Should().BeEquivalentTo(expected);

            output = vo_leetCodeAlg.twoSum(new int[] { 2, 5, -70, 0, 35, 41, 4, 4, 26, 29, 56, 21, -19, 38, 31, 33, 37, 39, -46, 65, 71, 68 }, -1000);
